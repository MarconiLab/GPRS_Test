...
void setup()
{
  ...
  delay(500);
  Serial.println("Start GPRS Shield test program");
  Serial.println("Terminal input 't' to SendTextMessage, 'd' DialVoiceCall, 'h' to HTTPRequest, 's' Pachube");
...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"+393898896252\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
...
void DialVoiceCall()
{
  mySerial.println("ATD + +393898896252;");//dial the number
...
void SubmitHttpRequest()
{
  ...
  mySerial.println("");
  Serial.println("Request submited");
  delay(100);
}
...
void Send2Pachube()
{
  ...
  delay(100);
  ShowSerialData();
  Serial.println("sent to Pachube");
}
